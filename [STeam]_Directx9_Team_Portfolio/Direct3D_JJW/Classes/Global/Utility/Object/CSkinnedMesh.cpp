...
CSkinnedMesh::CSkinnedMesh(const STParameters & parameters, SkinnedType skinnedType)
	:
...
bool CSkinnedMesh::PlayingAnimationTrue(void)
{
...
D3DXMATRIXA16 CSkinnedMesh::getMainWeaponBoundingWorldMatrix(void)
{
	auto frame = D3DXFrameFind(_rootFrame, _MainWeapon.c_str());
	return static_cast<CAllocateHierarchy::STBone *>(frame)->combineMatrix;
}

D3DXMATRIXA16 CSkinnedMesh::getSubWeaponBoundingWorldMatrix(void)
{
	auto frame = D3DXFrameFind(_rootFrame, _SubWeapon.c_str());
	return static_cast<CAllocateHierarchy::STBone *>(frame)->combineMatrix;
}

D3DXMATRIXA16 CSkinnedMesh::getThirdWeaponBoundingWorldMatrix(void)
{
