...
//! 계층 구조 할당자
class CAllocateHierarchyBoss : public ID3DXAllocateHierarchy
{
public:
	...
	struct STMeshContainer : public D3DXMESHCONTAINER
	{
		...
		std::vector<LPDIRECT3DTEXTURE9> normalTextureList;
	};
...
public:			// 생성자
	...
	//! 생성자
	explicit CAllocateHierarchyBoss(const STParameters & parameters);
