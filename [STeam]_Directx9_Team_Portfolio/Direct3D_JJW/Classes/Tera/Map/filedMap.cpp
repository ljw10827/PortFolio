...
void filedMap::init(void)
{
	...
	m_pTerrain->setPosition(D3DXVECTOR3(0.0f, m_pTerrainPositionY, 2.0f));
...
void filedMap::treePosition(void)
{
	for (int i = 0; i < NumberOfLeftWallBush; ++i)
	{
		...
		trees.push_back(m_pStaticMeshLeftWallBush[i]);
	}
	...
	for (int i = 0; i < NumberOfTopWallBush; ++i)
	{
		...
		trees.push_back(m_pStaticMeshTopWallBush[i]);
	}
	...
	for (int i = 0; i < NumberOfRIghtWallBush; ++i)
	{
		...
		trees.push_back(m_pStaticMeshRIghtWallBush[i]);
	}
	...
	for (int i = 0; i < NumberOfBottomWallBush; ++i)
	{
		...
		trees.push_back(m_pStaticMeshBottomWallBush[i]);
	}
	...
	for (int i = 0; i < NumberOfRIghtBottomEdgeBush; ++i)
	{
		...
		trees.push_back(m_pStaticMeshRIghtBottomEdgeBush[i]);
	}
	...
	m_pStaticMeshTree1[18]->setPosition(D3DXVECTOR3(96, 0.0f, -200));
	m_pStaticMeshTree1[19]->setPosition(D3DXVECTOR3(-70, 0.0f, -430));

	m_pStaticMeshTree1[20]->setPosition(D3DXVECTOR3(486, 0.0f, 212));
	m_pStaticMeshTree1[21]->setPosition(D3DXVECTOR3(-490 + 50, 0.0f, -240));
	m_pStaticMeshTree1[22]->setPosition(D3DXVECTOR3(-115, 0.0f, -385));
	...
	m_pStaticMeshTree1[28]->setPosition(D3DXVECTOR3(-220, 0.0f, -300));
	m_pStaticMeshTree1[29]->setPosition(D3DXVECTOR3(-190, 0.0f, -330));

	m_pStaticMeshTree1[30]->setPosition(D3DXVECTOR3(45, 0.0f, -166));
	m_pStaticMeshTree1[31]->setPosition(D3DXVECTOR3(-160, 0.0f, -360));
	m_pStaticMeshTree1[32]->setPosition(D3DXVECTOR3(12, 0.0f, -147));
	m_pStaticMeshTree1[33]->setPosition(D3DXVECTOR3(-150, 0.0f, -410));
	m_pStaticMeshTree1[34]->setPosition(D3DXVECTOR3(-10, 0.0f, 206));
	m_pStaticMeshTree1[35]->setPosition(D3DXVECTOR3(2, 0.0f, 236));
	m_pStaticMeshTree1[36]->setPosition(D3DXVECTOR3(70, 0.0f, 253));
	m_pStaticMeshTree1[37]->setPosition(D3DXVECTOR3(135, 0.0f, 345));
	m_pStaticMeshTree1[38]->setPosition(D3DXVECTOR3(190, 0.0f, 380));
	m_pStaticMeshTree1[39]->setPosition(D3DXVECTOR3(200, 0.0f, 465));

	m_pStaticMeshTree1[40]->setPosition(D3DXVECTOR3(-120, 0.0f, -110));
	m_pStaticMeshTree1[41]->setPosition(D3DXVECTOR3(-88, 0.0f, -94));
	m_pStaticMeshTree1[42]->setPosition(D3DXVECTOR3(-37, 0.0f, -105));
	m_pStaticMeshTree1[43]->setPosition(D3DXVECTOR3(-13, 0.0f, -104));
	...
	for (int i = 0; i < NumberOfTree1; ++i)
	{
		...
		trees.push_back(m_pStaticMeshTree1[i]);
	}
	...
	m_pStaticMeshTree2[0]->setPosition(D3DXVECTOR3(445, 0.0f, 118));
	m_pStaticMeshTree2[1]->setPosition(D3DXVECTOR3(380, 0.0f, 100));
	m_pStaticMeshTree2[2]->setPosition(D3DXVECTOR3(340, 0.0f, 120));
	m_pStaticMeshTree2[3]->setPosition(D3DXVECTOR3(280, 0.0f, 155));
	m_pStaticMeshTree2[4]->setPosition(D3DXVECTOR3(460, 0.0f, 200));
	m_pStaticMeshTree2[5]->setPosition(D3DXVECTOR3(212, 0.0f, 213));
	m_pStaticMeshTree2[6]->setPosition(D3DXVECTOR3(156, 0.0f, 259));
	...
	for (int i = 0; i < NumberOfTree2; ++i)
	{
		...
		trees.push_back(m_pStaticMeshTree2[i]);
	}
	...
	for (int i = 0; i < NumberOfTree3; ++i)
	{
		...
		trees.push_back(m_pStaticMeshTree3[i]);
	}
	...
	m_pStaticMeshTreeBoss[0]->setPosition(D3DXVECTOR3(400, 0.0f, 30));
	m_pStaticMeshTreeBoss[1]->setPosition(D3DXVECTOR3(70, 0.0f, -307));
	...
	m_pStaticMeshTreeBoss[21]->setPosition(D3DXVECTOR3(2, 0.0f, -314));
	m_pStaticMeshTreeBoss[22]->setPosition(D3DXVECTOR3(230 - 200, 0.0f, -290));
	m_pStaticMeshTreeBoss[23]->setPosition(D3DXVECTOR3(420, 0.0f, -20));
	m_pStaticMeshTreeBoss[24]->setPosition(D3DXVECTOR3(440, 0.0f, -35));
	m_pStaticMeshTreeBoss[25]->setPosition(D3DXVECTOR3(450, 0.0f, 10));
	m_pStaticMeshTreeBoss[26]->setPosition(D3DXVECTOR3(420, 0.0f, -25));
	m_pStaticMeshTreeBoss[27]->setPosition(D3DXVECTOR3(70, 0.0f, -307));
	m_pStaticMeshTreeBoss[28]->setPosition(D3DXVECTOR3(90, 0.0f, -290));
	m_pStaticMeshTreeBoss[29]->setPosition(D3DXVECTOR3(110, 0.0f, -310));
	...
	m_pStaticMeshTreeBoss[60]->setPosition(D3DXVECTOR3(40 - 100, 0.0f, -350));
	m_pStaticMeshTreeBoss[61]->setPosition(D3DXVECTOR3(260, 0.0f, -280 - 50));
	m_pStaticMeshTreeBoss[62]->setPosition(D3DXVECTOR3(60 - 100, 0.0f, -350));
	m_pStaticMeshTreeBoss[63]->setPosition(D3DXVECTOR3(18, 0.0f, -320));
	m_pStaticMeshTreeBoss[64]->setPosition(D3DXVECTOR3(45 - 100, 0.0f, -400));
	m_pStaticMeshTreeBoss[65]->setPosition(D3DXVECTOR3(70 - 100, 0.0f, -307 - 100));
	m_pStaticMeshTreeBoss[66]->setPosition(D3DXVECTOR3(90 - 100, 0.0f, -290 - 150));
	m_pStaticMeshTreeBoss[67]->setPosition(D3DXVECTOR3(110 - 100, 0.0f, -310 - 120));
	m_pStaticMeshTreeBoss[68]->setPosition(D3DXVECTOR3(130 - 100, 0.0f, -300 - 80));
	m_pStaticMeshTreeBoss[69]->setPosition(D3DXVECTOR3(80 - 100, 0.0f, -280 - 120));

	m_pStaticMeshTreeBoss[70]->setPosition(D3DXVECTOR3(260, 0.0f, -307 - 50));
	m_pStaticMeshTreeBoss[71]->setPosition(D3DXVECTOR3(265, 0.0f, -290 - 60));
	m_pStaticMeshTreeBoss[72]->setPosition(D3DXVECTOR3(270, 0.0f, -310 - 70));
	m_pStaticMeshTreeBoss[73]->setPosition(D3DXVECTOR3(275, 0.0f, -300 - 80));
	m_pStaticMeshTreeBoss[74]->setPosition(D3DXVECTOR3(280, 0.0f, -280 - 90));
	m_pStaticMeshTreeBoss[75]->setPosition(D3DXVECTOR3(280, 0.0f, -307 - 100));
	m_pStaticMeshTreeBoss[76]->setPosition(D3DXVECTOR3(285, 0.0f, -290 - 110));
	m_pStaticMeshTreeBoss[77]->setPosition(D3DXVECTOR3(290, 0.0f, -310 - 120));
	m_pStaticMeshTreeBoss[78]->setPosition(D3DXVECTOR3(295, 0.0f, -300 - 130));
	m_pStaticMeshTreeBoss[79]->setPosition(D3DXVECTOR3(300, 0.0f, -280 - 140));
	...
	for (int i = 0; i < NumberOfTreeBoss; ++i)
	{
		...
		trees.push_back(m_pStaticMeshTreeBoss[i]);
	}
	...
	for (int i = 0; i < NumberOfTreeBossDestroy1; ++i)
	{
		...
		trees.push_back(m_pStaticMeshTreeBossDestroy1[i]);
	}
	...
	for (int i = 0; i < NumberOfTreeBossDestroy2; ++i)
	{
		...
		trees.push_back(m_pStaticMeshTreeBossDestroy2[i]);
	}
}
