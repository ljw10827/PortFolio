...
#define NumberOfTree2 7
#define NumberOfTree3 1

#define NumberOfTreeBoss 89
...
public:
	...
	std::vector<CStaticMesh_Map *> getTreesVector(void) { return trees; }
...
private:
	...
	std::vector<CStaticMesh_Map *> trees;

private:
	CStaticMesh_Map * Human = nullptr;
	CStaticMesh_Map * General = nullptr;
	CStaticMesh_Map * Castanic = nullptr;
	CStaticMesh_Map * Soldier1 = nullptr;
	CStaticMesh_Map * Soldier2 = nullptr;
	CStaticMesh_Map * Rabbit1 = nullptr;
	CStaticMesh_Map * Rabbit2 = nullptr;
	CStaticMesh_Map * Rabbit3 = nullptr;
	CStaticMesh_Map * Sheep1 = nullptr;
	CStaticMesh_Map * Sheep2 = nullptr;
	CStaticMesh_Map * Sheep3 = nullptr;
};